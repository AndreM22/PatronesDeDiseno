...
public class NotePad implements IEditor {
	...
	public void crear(Documento documento) {
		System.out.println("***************");
		System.out.println("Creando el documento en NotePad");
		this.documento = documento;
		documento.showInfo();
	...
	public void editar(String contenido) {
		System.out.println("***************");
		System.out.println("Editando el documento en NotePad");
	...
	public void eliminar() {
		System.out.println("***************");
		System.out.println("Eliminando el documento en woNotePadrd");
